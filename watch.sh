#!/bin/bash
path="/home/mujtaba/Desktop/GitBois/Testing" # Replace this with the path to your git repository. To get path, run pwd in the directory or right click and select properties of the folder  
while true 
do
